...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?15c6a65948feb98a1e9a1b2e1b0b0f2e";
...
<div id="focusView" class="none">
	...
	<p>长按二维码，关注“贵人礼”<br/>
	   可得20元<img src="images/money.png" alt="diamond" class="diamond"></p>
</div>
...
<div id="exchangeRule" class="none">
	<div class="exContent">
		<div id="rose1">
			...
			<p class="pTitle">集齐3种物品可领取<br/>玫瑰一支</p>
			...
			<a href="https://shop15555171.koudaitong.com/v2/showcase/category?alias=16d9hw31x&sf=wx_sm&from=singlemessage&isappinstalled=0#rd"><button></button></a>   
		</div>
		<div id="roses">
			...
			<a href="https://shop15555171.koudaitong.com/v2/goods/3eqg6g3d2w2nf?reft=1455196169586&spm=c44162514&redirect_count=1&sf=wx_sm&from=singlemessage&isappinstalled=0"><button></button></a>   <!-- 商城链接？？？ -->
		</div>		
	</div>
</div>
<!-- 兑换1支玫瑰界面 -->
...
<div id='exchangeView1' class="none">
	...
	<form action='process_form1.php' method='post'>              
        <section> 
            ...
            <input type='text' class='user_name' name='user_name' required/>                           
		</section>              
        <section> 
        ...
        <section> 
            ...
            <input type='text' class='address' name='address' placeholder='领取地址：高新区锦业二路六和园'  required/>                           
        </section>             
        <section> 
    ...
    <div class="show"></div>
    <div class="middle">
		<p class="phone">客服电话：400-799-9316</p>
...
<script>
  ...
  wx.ready(function () {
      ...
      wx.onMenuShareAppMessage({
        title: '情人节，为至爱的人免费抢一束顶级玫瑰', 
        desc: '进入城市寻宝为你心中的女神寻找4种礼物，可兑换一束价值699元的顶级厄瓜多尔玫瑰！！！', // 分享描述
        link: 'http://rose111.applinzi.com/guirenli/index.php', // 分享链接？？？ 
